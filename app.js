...
app.get('/keyboard', function (req, res) {
    ...
    var data = {
        'message': {
            'text': '반갑습니다. 연성대학교 도우미 입니다. 『도움말』 버튼을 클릭해 주세요.'
        },
        'type': 'buttons',
        'buttons': ['도움말']
    };
...
app.post('/message', function (req, res) {
    ...
    switch (trimstring) {
        ...
        case '2유형':
            send = {
                'message': {
                    'text': '2유형 장학금은 대학교에서 주는 장학금으로 1유형 장학금을 받은 학생중에서 선발이 됩니다. 1유형을 받았어도 선택이 안될 수 있으니 심사를 기다려 보세요. \n 만약 1유형+2유형이 한학기 등록금을 초과할 경우 초과분은 미지급되며, 이후 학교에서의 성적장학금, 복지장학금등 기타 장학금은 받을 수 없다. 자세한건 장학금 지급 순서로 검색해 조세요.'
                }
            }
            break;
        ...
        case '장학금지급순서':
            send = {
                'message': {
                    'text': '장학금 지급 순서\n 장학금은 고지서에서 빠지며 빠지는 순서는 국가장학금 > 성적장학금으로 빠진다. 만약 한학기 등록금이 300만원 일때, 국가장학금으로 250만원을 받았고 성적장학금으로 100만원을 받을때, 성적장학금은 50만원만 받을 수 있고 50만원은 받을 수 없다.'
                }
            }
            break;
        case '성적장학금':
